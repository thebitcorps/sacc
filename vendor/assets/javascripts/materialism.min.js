...
fsm.directive("fsmStickyHeader", function() {
    ...
    }), fsm.directive("fsmBigData", ["$filter", function(a) {
        return {
            restrict: "AE",
            scope: !0,
            replace: !1,
...
var theme_colors = {
    ...
    app = angular.module("materialism", ["app.constants", "ngRoute", "ngAnimate", "ngSanitize", "ngPlaceholders", "ngTable", "angular-loading-bar", "angulartics", "angulartics.google.analytics", "uiGmapgoogle-maps", "ui.select", "gridshore.c3js.chart", "monospaced.elastic", "mgcrea.ngStrap", "jcs-autoValidate", "ngFileUpload", "textAngular", "fsm", "smoothScroll", "LocalStorageModule"]);
angular.module("app.constants", []).constant("APP", {
...
}]), app.controller("MainController", ["$scope", "$animate", "localStorageService", "todoService", "$alert", "$timeout", "$rootScope", function(a, b, c, d, e, f, g) {
    a.theme_colors = ["pink", "red", "purple", "indigo", "blue", "light-blue", "cyan", "teal", "green", "light-green", "lime", "yellow", "amber", "orange", "deep-orange"], service = new d(a), a.todosCount = service.count(), a.$on("todos:count", function(c, d) {
        ...
        g.$broadcast("theme:change", "Choose template"), a.theme.color = b
    }, a.changeTemplateTheme = function(b) {
        g.$broadcast("theme:change", "Choose color"), a.theme.template = b
    }, c.get("theme") || (theme = {
        color: "theme-pink",
...
}]), app.controller("ButtonsController", ["$scope", function(a) {
